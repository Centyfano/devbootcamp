...
/**
 * Send password reset token via mail, for forgotten password
...
/**
 * Reset password using the sent reset token
 * @route /api/v1/auth/resetpassword/:resettoken
 * @param resettoken A URL param
 * @method PUT
 * @access Public
 */
 ...
 * @param {*} user The user sent from the request object
 * @param {*} res Response
 */
const sendTokenResponse = (user, res) => {
	/** Send a 200 response status */
